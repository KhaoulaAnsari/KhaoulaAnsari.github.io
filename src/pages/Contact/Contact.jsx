...
export default function Contact() {
  ...
  const handleSubmit = async (e) => {
    ...
    form.append("to", "ansarikhaoula2@gmail.com");         // force recipient
    form.append("from_name", formData.name);               // sender name
    form.append("from_email", formData.email);             // sender email
    form.append("reply_to", formData.email);               // reply-to header
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <a
                      href="https://linkedin.com/in/khaoula-ansari-0b9627210"
                      target="_blank"
                      rel="noreferrer"
                      className="text-gray-400 hover:text-white"
                    >
                      khaoula-ansari-0b9627210
                    </a>
                  </div>
                </div>
